...
function updatePackageJson(options) {
  ...
  var cordovaScripts = [["init:cordova", "umi cordova --init"], ["init:android", "umi cordova add android --platform"], ["cordova:prepare", "umi cordova --prepare"], ["mock:android", "umi build && cordova emulate android"], ["run:android", "umi build && cordova run android"], ["release:android", "umi build && cordova build android --release"], ["init:ios", "umi cordova add ios --platform"], ["mock:ios", "umi build && cordova build ios && open -a Xcode ./platforms/ios/".concat(appName, ".xcworkspace")]];
