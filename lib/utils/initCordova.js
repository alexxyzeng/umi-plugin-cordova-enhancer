...
function addCordova() {
  ...
  _child_process.default.execSync("yarn add cordova && yarn add -D @types/cordova", {
    stdio: "inherit"
  });
}
...
function updatePackageJson(options) {
  ...
  var appName = (options === null || options === void 0 ? void 0 : (_options$config = options.config) === null || _options$config === void 0 ? void 0 : _options$config.name) || "";
  ...
  var cordovaScripts = [["init:cordova", "umi cordova --init"], ["init:android", "umi cordova add android --platform"], ["remove:android", "umi cordova rm android --platform"], ["prepare:cordova", "umi cordova --prepare"], ["mock:android", "umi build && umi cordova emulate android"], ["run:android", "umi build && umi cordova run android"], ["release:android", "umi build && umi cordova android --release"], ["init:ios", "umi cordova add ios --platform"], ["remove:ios", "umi cordova remove ios --platform"], ["mock:ios", "umi build && cordova build ios && open -a Xcode ./platforms/ios/".concat(appName, ".xcworkspace")], ["start:ui", "umi ui"], ["ci:ios", "cd platforms/ios && fastlane init"]];
