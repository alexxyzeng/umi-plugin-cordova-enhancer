...
function updatePackageJson(options) {
  ...
  var cordovaScripts = [["init:cordova", "umi cordova --init"], ["init:android", "umi cordova add android --platform"], ["prepare:cordova", "umi cordova --prepare"], ["mock:android", "umi build && umi cordova emulate android"], ["run:android", "umi build && umi cordova run android"], ["release:android", "umi build && umi cordova android --release"], ["init:ios", "umi cordova add ios --platform"], ["mock:ios", "umi build && cordova build ios && open -a Xcode ./platforms/ios/".concat(appName, ".xcworkspace")], ["start:ui", "umi ui"], ["ci:ios", "cd platforms/ios && fastlane init"]];
