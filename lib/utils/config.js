...
function parseConfig(options, outputPath) {
  var baseXml = _fs.default.readFileSync(_path.default.resolve(__dirname, "..", "config-base.xml"), "utf-8");
  ...
  _fs.default.writeFileSync(outputPath || options.configPath, (0, _xmlFormatter.default)(_xml2json.default.toXml(_objectSpread(_objectSpread({}, config), {}, {
    widget: finalWidget
  }))));
}
