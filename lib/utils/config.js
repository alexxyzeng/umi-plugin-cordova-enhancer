...
function writeInfos(widget, options) {
  ...
  var _options$locale = options.locale,
      ...
      prefs = options.prefs;
  var preference = finalWidget.preference;
  ...
  if (prefs) {
    finalWidget["preference"] = preference.map(function (item) {
      var name = item.name,
          value = item.value;
      var finalValue = prefs[name];
...
function updateConfig(widget, options) {
  _fs.default.writeFileSync(options.configPath, (0, _xmlFormatter.default)(_xml2json.default.toXml(widget)));
}